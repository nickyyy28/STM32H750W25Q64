...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 0, 0x25);
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 1, 0x25);
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 2, 0x25);
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 3, 0x25);
